    ...
    b.fn.fullpage = function (c) {
        ...
        function Q() {
            ...
            if (!c.autoScrolling && !f.hasClass("active")) {
                F = !0;
                var qa = b(".fp-section.active").index(".fp-section") + 1, g = G(f), h = f.data("anchor"), k = f.index(".fp-section") + 1, l = f.find(".fp-slide.active");
                if (l.length)var n = l.data("anchor"), t = l.index();
                f.addClass("active").siblings().removeClass("active");
                m || (b.isFunction(c.onLeave) && c.onLeave.call(this, qa, k, g), b.isFunction(c.afterLoad) && c.afterLoad.call(this, h, k));
                H(h, 0);
            ...
            c.scrollBar && (clearTimeout(S), S = setTimeout(function () {
                m || q(f)
            }, 1E3))
        }
        ...
        function ra(a) {
            ...
            if (!U(a.target)) {
                ...
                var e = T(a);
                m || t || (d = V(d), u = d.y, A = d.x, a.find(".fp-slides").length && Math.abs(B - A) > Math.abs(v - u) ? Math.abs(B - A) > b(window).width() / 100 * c.touchSensitivity &&
        ...
        function U(a, d) {
            d = d || 0;
            var e = b(a).parent();
            return d < c.normalScrollElementTouchThreshold && e.is(c.normalScrollElements) ? !0 : d == c.normalScrollElementTouchThreshold ? !1 : U(e, ++d)
        }
        ...
        function q(a, d, e) {
            ...
            if ("undefined" !== typeof f && (d = {
                ...
                c.autoScrolling && c.continuousVertical && "undefined" !== typeof d.isMovementUp && (!d.isMovementUp && "up" == d.yMovement || d.isMovementUp && "down" == d.yMovement) && (d.isMovementUp ? b(".fp-section.active").before(d.activeSection.nextAll(".fp-section")) : b(".fp-section.active").after(d.activeSection.prevAll(".fp-section").get().reverse()), n(b(".fp-section.active").position().top), X(), d.wrapAroundElements = d.activeSection, d.dest = d.element.position(), d.dtop = d.dest.top, d.yMovement = G(d.element));
        ...
        function ta(a) {
            if (c.css3 && c.autoScrolling && !c.scrollBar)Y("translate3d(0px, -" + a.dtop + "px, 0px)", !0), setTimeout(function () {
                Z(a)
        ...
        function ua(a) {
            var b = {};
            c.autoScrolling && !c.scrollBar ? (b.options = {top: -a.dtop}, b.element = "." + aa) : (b.options = {scrollTop: a.dtop}, b.element = "html, body");
            return b
        }

        function va(a) {
            a.wrapAroundElements && a.wrapAroundElements.length && (a.isMovementUp ? b(".fp-section:first").before(a.wrapAroundElements) : b(".fp-section:last").after(a.wrapAroundElements), n(b(".fp-section.active").position().top), X())
        }
        ...
        function w(a, d) {
            ...
            c.css3 ? (e = "translate3d(-" + e.left + "px, 0px, 0px)", ca(a.find(".fp-slidesContainer"), 0 < c.scrollingSpeed).css(da(e)), setTimeout(function () {
                u()
        ...
        function ia(a) {
            a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:' + ja(a) + 'px;" />')
        }
        ...
        function L(a, c) {
            ...
            a === p || e.hasClass("active") ? ka(e, c) : q(e, function () {
                ka(e, c)
            })
        }
        ...
        function I(a, b, e, f) {
            var g = "";
            c.anchors.length ? (a ? ("undefined" !== typeof e && (g = e), "undefined" === typeof b && (b = a), K = b, la(g + "/" + b)) : ("undefined" !== typeof a && (K = b), la(e)), D(location.hash)) : "undefined" !== typeof a ? D(f + "-" + a) : D(String(f))
        }

        function la(a) {
            if (ma)location.hash = a; else if (C || O)history.replaceState(void 0, void 0, "#" + a); else {
        ...
        function n(a) {
            c.scrollBar ? g.scrollTop(a) : c.css3 ? Y("translate3d(0px, -" + a + "px, 0px)", !1) : g.css("top", -a)
        }

        function da(a) {
            return {
                "-webkit-transform": a, "-moz-transform": a,
                "-ms-transform": a, transform: a
            }
        }
        ...
        b.fn.fullpage.setAutoScrolling = function (a) {
            ...
            c.autoScrolling && !c.scrollBar ? (b("html, body").css({
                overflow: "hidden",
                height: "100%"
            }), b.fn.fullpage.setRecordHistory(c.recordHistory), g.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), a.length && n(a.position().top)) : (b("html, body").css({
                overflow: "visible",
                height: "initial"
            }), b.fn.fullpage.setRecordHistory(!1), g.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), n(0), b("html, body").scrollTop(a.position().top))
        };
        b.fn.fullpage.setRecordHistory = function (a) {
            ma = a
        };
        ...
        b.fn.fullpage.setAllowScrolling = function (a, c) {
            if ("undefined" != typeof c)c = c.replace(" ", "").split(","), b.each(c,
                function (c, d) {
                    switch (d) {
                        case "up":
                            l.up = a;
                ...
                if (b.fn.fullpage.setMouseWheelScrolling(!0), C || O)MSPointer = na(), b(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, sa), b(document).off("touchmove " + MSPointer.move).on("touchmove " + MSPointer.move, ra)
            } else if (b.fn.fullpage.setMouseWheelScrolling(!1), C || O)MSPointer = na(), b(document).off("touchstart " +
        ...
        b.fn.fullpage.reBuild = function (a) {
            ...
            b(".fp-section").each(function () {
                ...
                c.verticalCentered && b(this).find(".fp-tableCell").css("height",
                    ja(b(this)) + "px");
        ...
        var t = !1, C = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|BB10|Windows Phone|Tizen|Bada)/),
            O = "ontouchstart"in window || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints, g = b(this), h = b(window).height(), m = !1, x = !1, p, K, k, aa = "fullpage-wrapper", l = {
                up: !0,
                down: !0,
                left: !0,
                right: !0
        ...
        b(this).length ? (g.css({
            height: "100%",
            position: "relative"
        }), g.addClass(aa)) : E("error", "Error! Fullpage.js needs to be initialized with a selector. For example: $('#myContainer').fullpage();");
        ...
        b(".fp-section").each(function (a) {
            ...
            "undefined" !== typeof c.anchors[a] && b(this).attr("data-anchor",
                c.anchors[a]);
            if (1 < f) {
                a = 100 * f;
                var g = 100 / f;
                ...
                c.controlArrows && oa(b(this));
                c.slidesNavigation && xa(b(this), f);
                e.each(function (a) {
                    b(this).css("width", g + "%");
                    c.verticalCentered && ia(b(this))
                });
                d = d.find(".fp-slide.active");
                0 == d.length ? e.eq(0).addClass("active") : J(d)
            } else c.verticalCentered && ia(b(this))
            ...
            c.scrollOverflow ?
                ("complete" === document.readyState && P(), b(window).on("load", P)) : b.isFunction(c.afterRender) && c.afterRender.call(this);
            fa();
        ...
        var R, S, F = !1;
        b(window).on("scroll", Q);
        var v = 0, B = 0, u = 0, A = 0;
        b(window).on("hashchange", ba);
        ...
        b.fn.fullpage.destroy = function (a) {
            ...
            b(window).off("scroll",
                Q).off("hashchange", ba).off("resize", ea);
